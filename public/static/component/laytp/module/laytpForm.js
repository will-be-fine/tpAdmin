    ...
    laytpForm.initData = {
        ...
        xmSelect: function (parentElem) {
            ...
            layui.each(obj, function (key, item) {
                ...
                options.inputTextField = $(item).data("inputtextfield") ? $(item).data("inputtextfield") : options.textField;
                    ...
                    label: {
                        block: {
                            template: function (item) {
                                let template = item[options.inputTextField];
         ...
         *  date-value="2022-03-24 00:00:00 - 2022-04-24 23:59:59"
